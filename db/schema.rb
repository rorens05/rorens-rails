...
ActiveRecord::Schema.define(version: 2022_06_09_010548) do
  ...
  create_table "tags_transactions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "tag_id"
